        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '20px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px', flex: 1, minWidth: '200px' }}>
            <svg 
              ...
              width="483.729" 
              height="486.595" 
              viewBox="0 0 483.729 486.595"
              aria-label="Knit by Machine Logo"
            >
              <g>
                {/* White circle background */}
                <circle cx="241.865" cy="241.865" r="241.865" fill="#fff"/>
                
                {/* Knitting machine frame */}
                <path d="M417.909,370.128H81.268V91.196h102.456c29.273,118.694,131.729,77.151,136.608,0h97.577v278.932Z" fill="#fff" stroke="#000" strokeMiterlimit="10" strokeWidth="4.395"/>
                
                {/* Knitting needles */}
                <path d="M118.554,256.792c-.309-10.912,5.383-15.001,11.21-15.614,5.826-.613,11.088,4.003,11.751,10.31.205,1.946.562,3.657.407,5.51h10.246c.108-1.488.091-3.01-.071-4.553-1.368-13.005-12.217-22.523-24.231-21.259-11.975,1.26-19.916,12.687-19.286,25.709l-.149,56.825.24,109.842h25.598s.33-109.854,0-109.925c-3.084-.663-19.071-6.604-15.728-56.807" fill="#2c3a57"/>
                <path d="M179.876,319.825c-.309-10.912,5.383-15.001,11.21-15.614,5.826-.613,11.088,4.003,11.751,10.31.205,1.946.562,3.657.407,5.51h10.246c.108-1.488.091-3.01-.071-4.553-1.368-13.005-12.217-22.523-24.231-21.259-11.975,1.26-19.916,12.687-19.286,25.709l-.149,56.825.24,109.842h25.598s.33-109.854,0-109.925c-3.084-.663-19.071-6.604-15.728-56.807" fill="#2c3a57"/>
                <path d="M302.519,319.825c-.309-10.912,5.383-15.001,11.21-15.614,5.826-.613,11.088,4.003,11.751,10.31.205,1.946.562,3.657.407,5.51h10.246c.108-1.488.091-3.01-.071-4.553-1.368-13.005-12.217-22.523-24.231-21.259-11.975,1.26-19.916,12.687-19.286,25.709l-.149,56.825.24,109.842h25.598s.33-109.854,0-109.925c-3.084-.663-19.071-6.604-15.728-56.807" fill="#2c3a57"/>
                <path d="M241.197,261.19c-.309-10.912,5.383-15.001,11.21-15.614,5.826-.613,11.088,4.003,11.751,10.31.205,1.946.562,3.657.407,5.51h10.246c.108-1.488.091-3.01-.071-4.553-1.368-13.005-12.217-22.523-24.231-21.259-11.975,1.26-19.916,12.687-19.286,25.709l-.149,56.825.24,109.842h25.598s.33-109.854,0-109.925c-3.084-.663-19.071-6.604-15.728-56.807" fill="#2c3a57"/>
                <path d="M363.84,256.792c-.309-10.912,5.383-15.001,11.21-15.614,5.826-.613,11.088,4.003,11.751,10.31.205,1.946.562,3.657.407,5.51h10.246c.108-1.488.091-3.01-.071-4.553-1.368-13.005-12.217-22.523-24.231-21.259-11.975,1.26-19.916,12.687-19.286,25.709l-.149,56.825.24,109.842h25.598s.33-109.854,0-109.925c-3.084-.663-19.071-6.604-15.728-56.807" fill="#2c3a57"/>
                
                {/* Sparkle on top - bright blue for visibility */}
                <path d="M350.5,150L360,130L369.5,150L389.5,159.5L369.5,169L360,189L350.5,169L330.5,159.5Z" fill="#4cace0" stroke="#4cace0" strokeWidth="2"/>
                <path d="M120.5,180L125,170L129.5,180L139.5,184.5L129.5,189L125,199L120.5,189L110.5,184.5Z" fill="#4cace0" stroke="#4cace0" strokeWidth="1.5"/>
                <path d="M380.5,320L385,310L389.5,320L399.5,324.5L389.5,329L385,339L380.5,329L370.5,324.5Z" fill="#4cace0" stroke="#4cace0" strokeWidth="1.5"/>
              </g>
            </svg>
            <div>
