...
export default function NecklineShapingWizard() {
  ...
  const remainingSts = castOnSts - neckSts;  // stitches remaining after neckline shaping
  const perSideSts = Math.floor(remainingSts / 2);  // stitches per side after shaping
  ...
  const generateInstructions = () => {
    ...
    leftShapingInstructions += `<span class="bullet-indent"><strong>${perSideSts} stitches remain on left side</strong></span><br>`;
    leftShapingInstructions += `<span class="bullet-indent">• Break yarn leaving a tail for seaming</span><br>`;
    leftShapingInstructions += `<span class="bullet-indent">• Scrap off ${perSideSts} stitches</span><br>`;
    ...
    rightShapingInstructions += `<span class="bullet-indent"><strong>${perSideSts} stitches remain on right side</strong></span><br>`;
    rightShapingInstructions += `<span class="bullet-indent">• Break yarn leaving a tail for seaming</span><br>`;
    rightShapingInstructions += `<span class="bullet-indent">• Scrap off ${perSideSts} stitches</span><br>`;
  ...
  const handleDownloadPDF = async () => {
    const content = `
      <div style="font-family: Arial, sans-serif; padding: 20px;">
        <div style="text-align: center; margin-bottom: 30px; padding-bottom: 20px; border-bottom: 2px solid #1E7E72;">
          <h1 style="color: #1E7E72; margin: 0; font-size: 28px;">Neckline Shaping Wizard</h1>
    ...
    const options = {
      margin: 0.5,
      filename: 'neckline-shaping-pattern.pdf',
